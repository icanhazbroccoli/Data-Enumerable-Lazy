# This Makefile is for the Data::Enumerable::Lazy extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Data/Enumerable/Lazy.pm]
#     AUTHOR => [q[Oleg S <me@whitebox.io>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     META_MERGE => { resources=>{ bugtracker=>q[https://github.com/icanhazbroccoli/Data-Enumerable-Lazy/issues], homepage=>q[https://github.com/icanhazbroccoli/Data-Enumerable-Lazy], repository=>{ web=>q[https://github.com/icanhazbroccoli/Data-Enumerable-Lazy], url=>q[https://github.com/icanhazbroccoli/Data-Enumerable-Lazy.git], type=>q[git] } }, meta-spec=>{ version=>q[2] } }
#     NAME => q[Data::Enumerable::Lazy]
#     PREREQ_PM => { Test::Exception=>q[0], Test::More=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Data/Enumerable/Lazy.pm]
...
MAKE = make
FULLEXT = Data/Enumerable/Lazy
BASEEXT = Lazy
PARENT_NAME = Data::Enumerable
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Data/Enumerable/Lazy.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Data/Enumerable/Lazy.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Data/Enumerable
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Data/Enumerable
...
TO_INST_PM = lib/Data/Enumerable/Lazy.pm

PM_TO_BLIB = lib/Data/Enumerable/Lazy.pm \
...
DISTNAME = Data-Enumerable-Lazy
DISTVNAME = Data-Enumerable-Lazy-0.03
...
manifypods : pure_all  \
	lib/Data/Enumerable/Lazy.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Data/Enumerable/Lazy.pm $(INST_MAN3DIR)/Data::Enumerable::Lazy.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Oleg S <me@whitebox.io>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Data-Enumerable-Lazy' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'resources:' >> META_new.yml
	$(NOECHO) $(ECHO) '  homepage: https://github.com/icanhazbroccoli/Data-Enumerable-Lazy' >> META_new.yml
	$(NOECHO) $(ECHO) '  repository: https://github.com/icanhazbroccoli/Data-Enumerable-Lazy.git' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "Oleg S <me@whitebox.io>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Data-Enumerable-Lazy",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '      "homepage" : "https://github.com/icanhazbroccoli/Data-Enumerable-Lazy",' >> META_new.json
	$(NOECHO) $(ECHO) '      "repository" : {' >> META_new.json
	$(NOECHO) $(ECHO) '         "type" : "git",' >> META_new.json
	$(NOECHO) $(ECHO) '         "url" : "https://github.com/icanhazbroccoli/Data-Enumerable-Lazy.git",' >> META_new.json
	$(NOECHO) $(ECHO) '         "web" : "https://github.com/icanhazbroccoli/Data-Enumerable-Lazy"' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Oleg S &lt;me@whitebox.io&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Data/Enumerable/Lazy.pm blib/lib/Data/Enumerable/Lazy.pm 
